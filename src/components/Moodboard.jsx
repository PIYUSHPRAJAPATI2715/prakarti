...
const photos = [
  ...
  { src: '/p2.jpeg', alt: 'Inspired 2', className: 'pw-2' },
  { src: '/p3.jpeg', alt: 'Inspired 3', className: 'pw-3' },
  { src: '/p4.jpeg', alt: 'Inspired 4', className: 'pw-4' },
  { src: '/p5.jpeg', alt: 'Inspired 5', className: 'pw-5' },
  { src: '/p6.jpeg', alt: 'Inspired 6', className: 'pw-6' },
]
  ...
  return (
    <section id="moodboard" className="moodboard-section">
      <div className="moodboard-container" ref={containerRef}>
        <div className="moodboard-doodle-1">Inspired by Nature</div>
